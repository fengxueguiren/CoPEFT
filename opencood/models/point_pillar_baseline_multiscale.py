...
class PointPillarBaselineMultiscale(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        spatial_features = batch_dict['spatial_features'] # torch.Size([10, 64, 200, 704])
        ...
        fused_feature = self.backbone.decode_multiscale_feature(fused_feature_list) # torch.Size([4, 256, 100, 352])

        if self.shrink_flag: # torch.Size([2, 384, 100, 252]) -> torch.Size([2, 256, 100, 252])
