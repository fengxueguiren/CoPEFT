...
class PointPillarBaselineMultiscaleCoPEFT(nn.Module):
    print('### PointPillarBaselineMultiscaleCoPEFT')
    def __init__(self, args):
        super(PointPillarBaselineMultiscaleCoPEFT, self).__init__()
        ...
        self.reg_head = nn.Conv2d(self.out_channel, 7 * args['anchor_number'],
                                  kernel_size=1)
        # The alias of CoPrompt is CoPEFT in paper.
    ...
    def forward(self, data_dict):
        ...
        ####
        # Communication in here.
        ####

        #### Agent Prompt and Collaboration Adapter 1 in CoPEFT
        # generate prompt and adapted features via CoPEFT
        ...
        for index, spatial_features_item in enumerate(spatial_features_regroup):
            # The implementation shown here is the simplest because cases exceeding the maximum number of vehicles rarely occur. A complete implementation can be achieved by incorporating an identity matrix.
            if spatial_features_item.shape[0] >= self.max_cav:
                ...
                # You can consider more Agent Prompts as needed.
                pass
